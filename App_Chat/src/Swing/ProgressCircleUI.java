...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/icons/download.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/icons/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/icons/file.png")).getImage();
    }
