...
public class Chat_Image extends javax.swing.JLayeredPane {
    ...
    private Dimension getAutoSize(Icon image, int w, int h) {
        ...
        double scale = Math.min(xScale, yScale); // Chọn tỉ lệ co giãn tối thiểu giữa tỉ lệ chiều rộng và chiều cao để đảm bảo hình ảnh không bị méo.
        int width = (int) (scale * iw);
        int height = (int) (scale * ih);
        return new Dimension(width, height);//Trả về một đối tượng Dimension mới với chiều rộng và chiều cao mới đã tính toán. Đối tượng Dimension này thường được sử dụng để đặt kích thước của một thành phần hoặc vùng vẽ.
    }
